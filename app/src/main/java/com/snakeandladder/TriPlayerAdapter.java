...
public class TriPlayerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        private ImageView one_th,two_th,three_th,four_th,five_th,six_th,seven_th,eight_th,nine_th,ten_th;
        public ViewHolder(View itemView) {
            ...
            one_th=itemView.findViewById(R.id.three_1);
            two_th=itemView.findViewById(R.id.three_2);
            three_th=itemView.findViewById(R.id.three_3);
            four_th=itemView.findViewById(R.id.three_4);
            five_th=itemView.findViewById(R.id.three_5);
            six_th=itemView.findViewById(R.id.three_6);
            seven_th=itemView.findViewById(R.id.three_7);
            eight_th=itemView.findViewById(R.id.three_8);
            nine_th=itemView.findViewById(R.id.three_9);
            ten_th=itemView.findViewById(R.id.three_10);
        }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view=inflater.inflate(R.layout.single_tri_player,parent,false);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if(array[numToDisplay-1][1]==1){
            ...
            viewHolder.one_t.setVisibility(View.GONE);
            viewHolder.one_th.setVisibility(View.GONE);
        }else if(array[numToDisplay-1][6]==1){
